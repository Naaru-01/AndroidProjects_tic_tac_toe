    ...
    fun checkwinner():Int
    {
        ...
        if((player1.contains(1) && player1.contains(2) && player1.contains(3) ) || (player1.contains(1) && player1.contains(4) && player1.contains(7))||
            ...
            if(player1Count==10){
                ...
                build.setTitle("            !     You Wins        !")
                build.setMessage("Your  Current Series is ongoing ... "+"\n\n\n" + "Do You Want To Continue ?")
            }
            ...
            if(player2Count==10){
                build.setTitle("! OPPONENT Wins Series by $player2Count - $player1Count  !")
                build.setMessage("\n\n\n" + "Do You Want To Play Another One ?")
                ...
                build.setTitle("            !     Opponent Wins        !")
                build.setMessage("Your  Current Series is ongoing ... "+"\n\n\n" + "Do You Want To Continue ?")
            }

                build.setPositiveButton("Yes ! I Defeat Opponent Now ..."){dialog, which ->
                    reset()
                    audio.release()
                }
                build.setNegativeButton("Exit"){dialog, which ->
            ...
            val build = AlertDialog.Builder(this)
            if(player2Count==2 && player1Count==2 && player1Count==player2Count){
                build.setTitle("HEY ! IT'S DRAW !")
                build.setMessage("\n This Series Has been Drawn," + "\n\n" + "Play Again ?")
            }else {
